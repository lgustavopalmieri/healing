...
const (
	SpecialistService_CreateSpecialist_FullMethodName = "/pb.SpecialistService/CreateSpecialist"
)
...
type SpecialistServiceClient interface {
	CreateSpecialist(ctx context.Context, in *CreateSpecialistRequest, opts ...grpc.CallOption) (*CreateSpecialistResponse, error)
}
...
func (c *specialistServiceClient) CreateSpecialist(ctx context.Context, in *CreateSpecialistRequest, opts ...grpc.CallOption) (*CreateSpecialistResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateSpecialistResponse)
	err := c.cc.Invoke(ctx, SpecialistService_CreateSpecialist_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SpecialistServiceServer interface {
	CreateSpecialist(context.Context, *CreateSpecialistRequest) (*CreateSpecialistResponse, error)
...
func (UnimplementedSpecialistServiceServer) CreateSpecialist(context.Context, *CreateSpecialistRequest) (*CreateSpecialistResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateSpecialist not implemented")
}
...
func _SpecialistService_CreateSpecialist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SpecialistService_CreateSpecialist_FullMethodName,
	}
...
var SpecialistService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.SpecialistService",
	...
	Metadata: "internal/modules/specialist/features/create/infra/grpc_service/proto/specialist.proto",
}
