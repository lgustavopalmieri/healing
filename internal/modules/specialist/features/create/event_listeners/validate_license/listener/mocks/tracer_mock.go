...
//
//	mockgen -source=internal/commom/observability/tracing.go -destination=internal/modules/specialist/features/create/event_listeners/validate_license/listener/mocks/tracer_mock.go -package=mocks
//
