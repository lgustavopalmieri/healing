...
//
//	mockgen -source=internal/commom/observability/tracing.go -destination=internal/modules/specialist/features/create/application/mocks/tracer_mock.go -package=mocks
//
