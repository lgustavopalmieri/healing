...
//
//	mockgen -source=internal/modules/specialist/features/search/adapters/inbound/http_handler/handler.go -destination=internal/modules/specialist/features/search/adapters/inbound/http_handler/mocks/command_mock.go -package=mocks
//
