...
func (r *Repository) mapSortFieldToOS(field searchinput.SearchableField) string {
	switch field {
...
func (r *Repository) mapToSpecialist(source opensearchSource) *domain.Specialist {
	return &domain.Specialist{
		...
		Status:        domain.SpecialistStatus(source.Status),
