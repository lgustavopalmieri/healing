...
//
//	mockgen -source=internal/commom/observability/tracing.go -destination=internal/modules/specialist/features/update/event_listeners/update_data_repositories/listener/mocks/tracer_mock.go -package=mocks
//
