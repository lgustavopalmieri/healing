...
func IndexSpecialists(t *testing.T, ctx context.Context, client *opensearchapi.Client, indexName string, specialists []*SpecialistDocument) {
	for _, specialist := range specialists {
		...
		require.NoError(t, err, fmt.Sprintf("failed to index document: %s", specialist.ID))
	}
}
